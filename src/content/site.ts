...
export const copy = {
  ...
  about: {
    ...
    body: [
      'I am a Turkish researcher living in Krakow. Alongside my PhD, I work as a ServiceNow Developer at EY GDS Poland and hold professional ServiceNow certifications. My software background includes Python automation, REST APIs, React, TypeScript and C#. I used C# more extensively before moving toward Java and Spring for work.',
